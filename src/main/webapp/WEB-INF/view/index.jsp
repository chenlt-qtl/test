...
<div class="am-g tpl-g">
        ...
        <div class="tpl-sidebar-user-panel">
            <div class="tpl-user-panel-slide-toggleable">
                <div class="tpl-user-panel-profile-picture">
                    <img src="/file/photo/${loginUser.photo}<c:if test="${empty loginUser.photo}">user06.png</c:if>" alt="用户头像">
                </div>
    ...
    <div class="tpl-content-wrapper">
        <iframe name="main-content" id="main-content" src="${ctx}/welcome" style="width:100%;" scrolling="no" frameborder="no"></iframe>
    </div>
</div>
</div>
